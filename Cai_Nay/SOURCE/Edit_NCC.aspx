<%@ Page Title="" Language="C#" MasterPageFile="~/TemplateAdmin.Master" AutoEventWireup="true" CodeBehind="Edit_NCC.aspx.cs" Inherits="SOURCE.Edit_NCC" %>
			...
			<div class="account-bottom">
				<div class="col-md-6 account-left">
                    ...
                    <div style="margin-top:8px">
                        ...
                        <asp:TextBox runat="server" required="" ID="txtProducerName" style="font-size:14px;width:100%;padding:10px 10px;border:1px solid #242424;outline:none;font-family:'Lato', sans-serif;"></asp:TextBox>
					</div>

                    <div style="margin-top:8px">
						<span>Address</span>
                        <asp:TextBox runat="server" required="" ID="txtAddress" style="font-size:14px;width:100%;padding:10px 10px;border:1px solid #242424;outline:none;font-family:'Lato', sans-serif;"></asp:TextBox>
					</div>

                   <div style="margin-top:8px">
						<span>Active Time</span>
                        <asp:TextBox runat="server" required="" ID="txtActiveTime" style="font-size:14px;width:100%;padding:10px 10px;border:1px solid #242424;outline:none;font-family:'Lato', sans-serif;"></asp:TextBox>
					</div>
                    ...
                    <div style="margin-top:8px">
						<span>Mail</span>
                        <asp:TextBox runat="server" ID="txtMail" required="" style="font-size:14px;width:100%;padding:10px 10px;border:1px solid #242424;outline:none;font-family:'Lato', sans-serif;"></asp:TextBox>
					</div>
