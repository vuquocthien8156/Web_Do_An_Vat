<%@ Page Title="" Language="C#" MasterPageFile="~/TemplateAdmin.Master" AutoEventWireup="true" CodeBehind="Edit_Products.aspx.cs" Inherits="SOURCE.Edit_Products" EnableEventValidation="false" %>
		...
		<div class="container" > 
			<div class="account-bottom">
				<div class="col-md-6 account-left">
					...
					<div>
						<asp:Button runat="server" ID="btnSubmit" Text="UPDATE"  style ="margin-top:10px;width:100px;height:50px;background:red;color:white;border:1px solid #242424;border-radius:3px" OnClick="btnSubmit_Click" ></asp:Button>
					</div>
				</div>
