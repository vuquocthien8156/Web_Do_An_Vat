<%@ Page Title="" Language="C#" MasterPageFile="~/Template.Master" AutoEventWireup="true" CodeBehind="allProducts.aspx.cs" Inherits="SOURCE.allProducts" EnableEventValidation="false" %>
    	...
    	<div class="w3l_banner_nav_right">
			<div class="w3ls_w3l_banner_nav_right_grid w3ls_w3l_banner_nav_right_grid_sub">
								...
								<figure>
									<div class="snipcart-item block">
										...
										<div class="snipcart-details">
                                            <a href="allProducts.aspx?productidd=<%#Eval("Masp")%>" style="border:4px dotted black;padding:5px;background:red;color:white">Add to cart</a>
                                        </div>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.aspx"><img src="images/18.png" alt=" " class="img-responsive" /></a>
											<p>dish wash bar (500 gm)</p>
											<h4>$2.00 <asp:Label runat="server">$4.00</asp:Label></h4>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.aspx"><img src="images/19.png" alt=" " class="img-responsive" /></a>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.aspx"><img src="images/20.png" alt=" " class="img-responsive" /></a>
											<p>toilet cleaner expert (1 ltr)</p>
											<h4>$6.00 <asp:Label runat="server">$7.00</asp:Label></h4>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
                ...
                <div style="margin-left:300px;margin-top:20px">
                     <asp:Button ID="btnDau" runat="server" Text="Về Đầu" OnClick="btnDau_Click" />
                    <asp:Button ID="btnVe" runat="server" Text="Về" OnClick="btnVe_Click" />
                    <asp:TextBox ID="tbHienthi" runat="server" style="width:50px"></asp:TextBox>
                    <asp:Button ID="btnQua" runat="server" Text="Qua" OnClick="btnQua_Click" />
                    <asp:Button ID="btnCuoi" runat="server" Text="Tới Cuối" OnClick="btnCuoi_Click" />
                </div>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.aspx"><img src="images/21.png" alt=" " class="img-responsive" /></a>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.aspx"><img src="images/22.png" alt=" " class="img-responsive" /></a>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.aspx"><img src="images/23.png" alt=" " class="img-responsive" /></a>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.aspx"><img src="images/24.png" alt=" " class="img-responsive" /></a>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.aspx"><img src="images/25.png" alt=" " class="img-responsive" /></a>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.aspx"><img src="images/26.png" alt=" " class="img-responsive" /></a>
											<p>young adult dogs (1.2 kg)</p>
											<h4>$6.00 <asp:Label runat="server">$10.00</asp:Label></h4>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.aspx"><img src="images/27.png" alt=" " class="img-responsive" /></a>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.aspx"><img src="images/28.png" alt=" " class="img-responsive" /></a>
											<p>chicken in jelly can (400 gm)</p>
											<h4>$7.00 <asp:Label runat="server">$9.00</asp:Label></h4>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
