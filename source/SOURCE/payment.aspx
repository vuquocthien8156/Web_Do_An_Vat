<%@ Page Title="" Language="C#" MasterPageFile="~/Template.Master" AutoEventWireup="true" CodeBehind="payment.aspx.cs" Inherits="SOURCE.payment" %>
...
<!-- payment -->
		<div class="privacy about">
			<h3>Pay<asp:Label runat="server">ment</asp:Label></h3>
												...
												<div class="check_box_one cashon_delivery">
													<label class="anim">
																<input type="checkbox" class="checkbox">
																 <asp:Label runat="server"> We also accept Credit/Debit card on delivery. Please Check with the agent.</asp:Label> 
															</label> 
											</div>
                    ...
                    <form action="#" method="post" class="creditly-card-form agileinfo_form">
									<section class="creditly-wrapper wthree, w3_agileits_wrapper">
										<div class="credit-card-wrapper">
											...
											<button class="submit"><asp:Label runat="server">Make a payment </asp:Label></button>
										</div>
									</section>
								</form>
                ...
                <div>
                                     <div class="vertical_post">
									  <form action="#" method="post">
										...
										<asp:Button runat="server" value="PAY NOW"/>
									</form>
								</div>
                </div>
                <div>
                            ...
                            <form class="cc-form">
                                <div class="clearfix">
                                    <div class="form-group form-group-cc-number">
                                        ...
                                        <input class="form-control" placeholder="xxxx xxxx xxxx xxxx" type="text"><asp:Label runat="server" class="cc-card-icon"></asp:Label>
                                    </div>
